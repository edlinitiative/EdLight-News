...
14. IG_NARRATIVE (CARROUSEL INSTAGRAM — IMPÉRATIF): Écris ig_narrative comme 2–3 GROUPES de phrases séparés par |||, chaque groupe formant un slide cohérent qui s'enchaîne naturellement avec le suivant comme une histoire. Structure: groupe 1 = le fait central (2–3 phrases), groupe 2 = conséquences et contexte (2–3 phrases), groupe 3 si pertinent = ce que ça signifie pour le lecteur (1–2 phrases). Chaque groupe doit lire comme un mini-paragraphe fluide. PAS de parenthèses, PAS de crochets — récris les détails comme "X (Y)" → "X — Y". RÈGLE ABSOLUE DE LONGUEUR: chaque phrase individuelle MAX 200 CARACTÈRES — pas de virgules empilées, pas de subordonnées en cascade. Une phrase = une idée = un seul verbe principal. Si une phrase dépasse 200 caractères, divise-la obligatoirement en deux. Format exact attendu: "Phrase 1a. Phrase 1b. Phrase 1c.|||Phrase 2a. Phrase 2b. Phrase 2c.|||Phrase 3a. Phrase 3b."
...
RÉPONDS UNIQUEMENT en JSON valide avec cette structure exacte:
{
  ...
  "ig_narrative": "2-3 groupes séparés par |||, chaque groupe = 2-3 phrases formant un slide cohérent, CHAQUE phrase MAX 200 caractères. Ex: 'Fait A. Fait B.|||Contexte C. Impact D. Suite E.|||Signification F. Appel G.'",
  "confidence": 0.85,
  "haiti_relevant": true,
