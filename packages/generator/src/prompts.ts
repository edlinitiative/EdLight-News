...
RÉPONDS UNIQUEMENT en JSON valide avec cette structure exacte:
{
  ...
  "ig_narrative": "3-4 groupes séparés par |||, arc en 4 actes: CE QUI S'EST PASSÉ|||POURQUOI C'EST IMPORTANT|||FAIT CLÉ|||POUR LE LECTEUR. CHAQUE phrase MAX 200 caractères. Ex: 'Fait A survient. Contexte B.|||Conséquence C. Impact D.|||Chiffre E ou citation F.|||Ce que ça signifie pour vous G.'",
  "confidence": 0.85,
  "haiti_relevant": true,
