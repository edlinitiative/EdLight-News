    ...
    <section className="space-y-7 rounded-xl border border-stone-200 bg-white p-5 shadow-sm dark:border-stone-700 dark:bg-stone-900/70 sm:p-7">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold tracking-tight text-stone-900 dark:text-white sm:text-3xl">
          <Calendar className="mr-2 inline h-6 w-6 text-blue-600" />
          {fr ? "Explorer l\u2019histoire" : "Eksplore istwa"}
        </h2>
        <p className="mx-auto mt-2 max-w-2xl text-sm leading-relaxed text-stone-600 dark:text-stone-400">
          {fr
        ...
        <div className="flex justify-center">
          ...
          <button
            ...
            className={
              ...
              (viewMode === "week"
                ? "bg-white text-blue-700 shadow-sm dark:bg-stone-800 dark:text-blue-400"
          ...
          <button
            ...
            className={
              ...
              (tag === ""
                ...
                : "border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800 text-stone-600 dark:text-stone-300 hover:bg-stone-50 dark:hover:bg-stone-700")
            }
          >
            {fr ? "Tous" : "Tout"}
          </button>
          {FILTER_TAGS.map((t) => {
            ...
            return (
              <button
                ...
                className={
                  "inline-flex items-center gap-1 rounded-lg px-4 py-1.5 text-xs font-semibold transition " +
                  (isActive
                    ? "bg-stone-900 text-white shadow-sm dark:bg-white dark:text-stone-900"
                    : `border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800 hover:bg-stone-50 dark:hover:bg-stone-700 ${tl.color}`)
                }
              >
      ...
      {viewMode === "week" && (
        <>
          ...
          <div className="flex items-center justify-center gap-4 rounded-xl border border-stone-200 bg-white px-3 py-2.5 dark:border-stone-700 dark:bg-stone-800">
            ...
            <div className="text-center">
              <span className="text-base font-semibold tracking-tight text-stone-900 dark:text-white sm:text-lg">
                {weekLabel || "\u00a0"}
              </span>
              {weekOffset !== 0 && (
                <button
                ...
                return (
                  ...
                  >
                    ...
                    {dayHolidays.map((h) => (
                      <div
                        key={h.id}
                        className="mx-3 mt-3 flex items-center gap-2 rounded-lg bg-gradient-to-r from-blue-50 dark:from-blue-900/30 to-blue-50 dark:to-blue-900/30 px-3 py-2 text-xs font-semibold text-blue-700 dark:text-blue-300"
                      >
                        <Star className="h-3.5 w-3.5 text-blue-500" />
                        {fr ? h.name_fr : h.name_ht}
                        {h.isNationalHoliday && (
                          <span className="ml-auto text-[10px] font-semibold uppercase tracking-wide text-blue-400">
                      ...
                      {mainFact ? (
                        <>
                          ...
                          <div className="rounded-xl border border-blue-100 dark:border-blue-800 bg-blue-50/40 dark:bg-blue-900/20 p-3.5">
                            ...
                            <h4 className="text-sm font-bold leading-snug text-stone-900 dark:text-white">
                              {mainFact.title_fr}
                            </h4>
                            <p className="mt-1.5 text-xs leading-relaxed text-stone-600 dark:text-stone-300 line-clamp-4">
                              {mainFact.summary_fr}
                            </p>
                            {mainFact.student_takeaway_fr && (
                              <p className="mt-2.5 text-[11px] leading-relaxed text-blue-700 dark:text-blue-300">
                                {mainFact.student_takeaway_fr}
                              </p>
                            )}
                              ...
                              <div className="mt-2 flex flex-wrap gap-1">
                                {mainFact.tags.slice(0, 2).map((t) => {
                                  ...
                                  return (
                                    <span
                                      key={t}
                                      className={`rounded-full px-2 py-0.5 text-[9px] font-medium ${tl?.color ?? "bg-stone-100 text-stone-700 dark:bg-stone-700 dark:text-stone-300"}`}
                                    >
                                      {fr ? tl?.fr : tl?.ht}
                                    </span>
                                  );
                            ...
                            <div className="rounded-xl border border-stone-100 bg-stone-50/70 p-3 dark:border-stone-700 dark:bg-stone-700/40">
                              ...
                              <div className="space-y-2">
                                {secondaryFacts.map((entry) => (
                                  <div
                                    key={entry.id}
                                    className="rounded-lg border border-stone-100 bg-white px-2.5 py-2 dark:border-stone-700 dark:bg-stone-900/70"
                                  >
                                    <div className="flex items-start gap-1.5">
                                      {entry.year != null && (
                                        <span className="shrink-0 rounded bg-stone-200 px-1.5 py-0.5 text-[10px] font-medium text-stone-600 dark:bg-stone-600 dark:text-stone-300">
                                          {entry.year}
                                        </span>
                                      )}
                                      <h5 className="text-xs font-semibold leading-snug text-stone-800 dark:text-stone-200">
                                        {entry.title_fr}
                                      </h5>
                                    </div>
                        ...
                        <div className="flex flex-1 flex-col items-center justify-center rounded-lg border-2 border-dashed border-stone-100 dark:border-stone-700 py-6 text-center">
                          <BookOpen className="mb-1.5 h-5 w-5 text-stone-300 dark:text-stone-600" />
        ...
        <>
            ...
            {Array.from({ length: 12 }, (_, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[10px] font-medium ${isActive ? "text-white/80 dark:text-stone-900/60" : "text-stone-400 dark:text-stone-500"}`}
                  >
                    {shortName}
                  </span>
                </button>
          ...
          {!loading && fetched && (
            <div className="space-y-8">
              ...
              {entries.length > 0 ? (
                <div>
                  <h3 className="mb-4 text-lg font-bold text-stone-900 dark:text-white">
                    {monthName} —{" "}
                  ...
                  <div className="relative">
                    {/* Timeline line */}
                    {entries.length > 1 && (
                      <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-200 via-blue-100 to-transparent" />
                    )}
                      ...
                      {entries
                        ...
                        .map((entry) => {
                          ...
                          return (
                            ...
                            >
                              {/* Timeline date node */}
                              <div className="relative z-10 flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-full border-2 border-blue-200 dark:border-blue-700 bg-white dark:bg-stone-800 text-blue-700 dark:text-blue-400 shadow-sm">
                              ...
                              <div className="min-w-0 flex-1 rounded-xl border border-stone-200 bg-white p-4 shadow-sm transition hover:shadow-md dark:border-stone-700 dark:bg-stone-800 sm:p-5">
                                <div className="flex flex-wrap items-start justify-between gap-2">
                                  <h4 className="text-sm font-bold leading-snug text-stone-900 dark:text-white sm:text-base">
                                    {entry.title_fr}
                                    {entry.year != null && (
                                      <span className="ml-1.5 rounded bg-stone-100 dark:bg-stone-700 px-1.5 py-0.5 text-xs font-medium text-stone-500 dark:text-stone-400">
                                        {entry.year}
                                      </span>
                                    )}
                                  </h4>
                                </div>
                                <p className="mt-2.5 line-clamp-3 text-sm leading-6 text-stone-600 dark:text-stone-300">
                                  {entry.summary_fr}
                                </p>
                                {entry.tags &&
                                  entry.tags.length > 0 && (
                                      ...
                                      {entry.tags
                                        ...
                                        .map((t) => {
                                          ...
                                          return (
                                            <span
                                              key={t}
                                              className={`rounded-full px-2 py-0.5 text-[10px] font-medium ${tl?.color ?? "bg-stone-100 text-stone-700 dark:bg-stone-700 dark:text-stone-300"}`}
                                            >
                                              {fr ? tl?.fr : tl?.ht}
                                            </span>
                                          );
