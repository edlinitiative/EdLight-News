/**
 * HomepageLegacy — pre-bourses-led variant of the homepage.
 *
 * Preserved verbatim (modulo conversion from a route to a component) so we
 * can switch back via the `NEXT_PUBLIC_HOMEPAGE_VARIANT=legacy` env var if
 * the new layout under-performs. Once the new variant is validated this
 * file can be deleted.
 *
 * Original design philosophy: text-first, newspaper density.
 *  Sections (top → bottom):
 *  1. Dateline bar
...
export async function HomepageLegacy({
  lang,
}: {
