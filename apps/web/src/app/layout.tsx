  ...
  return (
    <html lang="fr" suppressHydrationWarning className={`${display.variable} ${sans.variable}`}>
      <head>
        ...
        {/* eslint-disable-next-line @next/next/no-page-custom-font -- Material Symbols cannot be loaded via next/font; root layout is equivalent to _document.js in App Router */}
        <link
