/** Loading skeleton for /haiti */
export default function Loading() {
  return (
    <div className="animate-pulse space-y-6">
      <header className="space-y-2">
        <div className="h-10 w-48 rounded-lg bg-stone-200 dark:bg-stone-700" />
        <div className="h-4 w-80 max-w-full rounded bg-stone-100 dark:bg-stone-700" />
        <div className="h-3 w-24 rounded bg-stone-100 dark:bg-stone-700" />
      </header>
