...
export default function Loading() {
  return (
    <article className="mx-auto max-w-3xl animate-pulse space-y-6">
      {/* Hero image */}
      <div className="aspect-video w-full rounded-xl bg-stone-200 dark:bg-stone-700" />
      ...
      {/* Summary */}
      <div className="h-5 w-full rounded bg-stone-100 dark:bg-stone-700" />
      <div className="h-5 w-5/6 rounded bg-stone-100 dark:bg-stone-700" />
