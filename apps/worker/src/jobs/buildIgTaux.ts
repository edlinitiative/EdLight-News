...
async function formatTauxCarousel(taux: TauxBRH): Promise<IGFormattedPayload> {
  ...
  const caption = [
    ...
    ...(taux.bankBuy != null && taux.bankSell != null ? [`Bancaire — Achat: ${taux.bankBuy.toFixed(4)} | Vente: ${taux.bankSell.toFixed(4)}`] : []),
    ...(taux.informalBuy != null && taux.informalSell != null ? [`Informel — Achat: ${taux.informalBuy.toFixed(4)} | Vente: ${taux.informalSell.toFixed(4)}`] : []),
    "",
    "To BRH pou jodi a",
